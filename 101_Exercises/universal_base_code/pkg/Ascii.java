...
public class Ascii {
	...
	public Ascii(String a, String b, String c, int d){
		type = checkType(a);
		name = b;
		girlfriend = c;
		number = d;
	...
	public void printArt(){				// Prints out the name and the art number times
		...
		System.out.println(name+"'s girlfriend's name is "+girlfriend+"!");
		int i = 0;
		while (i < number){
			if(type.equals("Human")){
				...
				System.out.println("    | | ::::::::::::::::: | |  |");
				System.out.println("    | | ::::::::::::::::: | | ,|");
				System.out.println("    | !___________________! |(c|");
